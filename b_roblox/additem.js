   ...
   return `
     <div class="col-xl-3 col-lg-4 col-md-6">
       <div class="gallery-item h-100">
         <img src="gallery/${item}.jpg" class="img-fluid" alt="Roblox ${item.replace("_" , " ")}">
         <div class="gallery-links d-flex align-items-center justify-content-center">
           <a href="gallery/${item}.jpg" title="Roblox ${item.replace("_" , " ")}" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
